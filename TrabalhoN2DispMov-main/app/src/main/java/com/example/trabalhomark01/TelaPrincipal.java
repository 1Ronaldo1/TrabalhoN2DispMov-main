...
public class TelaPrincipal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Botão que direciona para a tela de dietas
        bt_to_dietas.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TelaPrincipal.this,dietas.class);
                startActivity(intent);
            }
        });
    ...
    private void IniciarComponentes(){
        ...
        bt_to_dietas = findViewById(R.id.bt_to_dietas);
    }
}